export default function Contact() {
  return (
    <div
      ...
      className="relative mt-20 mb-40 bg-[url('/assets/HomeHeroBg.svg')] bg-cover bg-center md:mx-24 mx-3 md:px-7 px-3 md:pt-3 pb-5 rounded-tl-[4rem] rounded-br-[4rem] flex md:flex-row flex-col-reverse justify-between max-w-lvw "
    >
      {/* left section */}
      <div className="w-3/4">
        <h1 className="md:text-[26px] text-lg font-bold text-[#0D2131] md:mt-5 mt-7  ">
      ...
      <div>
        <img
          src="/assets/man.svg"
          className="absolute bottom-0 right-10 h-[115%]"
          alt=""
        />
      </div>
      <div className="absolute right-3 text-[#254055] text-center bg-white rounded-tl-2xl rounded-br-2xl h-fit px-3 py-3 ">
