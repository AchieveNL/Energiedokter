...
//       {/* Mobile Navigation */}
//       <div
//         className={`md:hidden flex overflow-hidden transition-all duration-300 ease-in-out h-screen w-2/3 absolute right-0 top-0 ${
//           isMenuOpen ? "translate-x-0" : "translate-x-full"
//         }`}
//       >
//         <div className="bg-[white] flex flex-col w-full px-2 relative">
//           <button
//             className="md:hidden flex flex-col gap-1.5 p-2 my-3 mr-2 self-end"
//             onClick={() => setIsMenuOpen(!isMenuOpen)}
//             aria-label="Toggle menu"
//           >
//             <span
  ...
  return (
    <nav className="fixed w-full backdrop-blur-lg z-50">
      <div className="flex p-4 px-4 md:px-10 justify-between md:justify-around items-start">
        ...
        {/* Hamburger Menu Button */}
        <button
          className="md:hidden flex flex-col gap-1.5 p-2 mt-1 relative z-[60]"
          onClick={() => setIsMenuOpen(!isMenuOpen)}
          aria-label="Toggle menu"
        >
          <span
      ...
      {/* Backdrop Overlay */}
      <div
        className={`md:hidden fixed inset-0 bg-[#65616180] backdrop-blur-sm transition-opacity duration-300 h-screen ${
          isMenuOpen
      ...
      {/* Mobile Navigation */}
      <div
        className={`md:hidden flex overflow-hidden transition-all duration-300 ease-in-out h-screen w-2/3 fixed right-0 top-0 z-[55] ${
          isMenuOpen ? "translate-x-0" : "translate-x-full"
        }`}
      >
