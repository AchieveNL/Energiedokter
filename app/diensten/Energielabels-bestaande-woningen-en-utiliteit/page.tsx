...
import animationData from "@/public/assets/animations/bestaand.json";
...
export default function Service1() {
  ...
  return (
    <>
      ...
      <div className="px-5 min-[768px]:px-20 min-[1280px]:px-32 min-[1700px]:px-50 min-[2000px]:px-80">
        <ServiceOverview
          ...
          spans={
            <>
              <p>
                ...
                nodig is voor een comfortabel binnenklimaat en toont precies
                waar u kunt besparen. Het energielabel wordt bepaald op basis
                van bouwkundige en installatietechnische eigenschappen, zoals
              ...
              <p>
                Bij Energie Dokter bekijken onze gecertificeerde
                energieadviseurs uw woning zorgvuldig en registreren we het
                officiële energielabel bij de RVO. Zo bent u verzekerd van een
                label, dat voldoet aan de wettelijke verplichtingen bij verkoop
                of verhuur.
              </p>
              <p>
        ...
        <div
          ...
          className="md:mt-20 mt-10 flex flex-col gap-2 items-center"
        >
          <h1 className="md:text-3xl text-2xl font-bold text-[#254055]">
            Energieverlies is{" "}
            <span className="text-[#81C713] ">winstverlies</span>, ontdek waar
            uw gebouw lekt.
          </h1>
          ...
          title={
            <div>
              <h1 className="text-[#254055] font-extrabold md:text-3xl text-2xl ">
                Grip op energie,{" "}
                <span className="text-[#81C713] ">waarde </span>
                voor uw pand
              </h1>
          ...
          text={
            <>
              <p className="text-sm text-[#4D4D4D] ">
                ...
                aangenaam aanvoelt en meer waard is op de markt. Geen zorgen
                meer over onverwacht hoge rekeningen of verouderde installaties,
                maar weten dat jouw woning voldoet aan de eisen van morgen. Met
                het juiste energielabel zet je die stap — naar een duurzame,
                zorgeloze en toekomstbestendige woning.
              </p>
            </>
          }
